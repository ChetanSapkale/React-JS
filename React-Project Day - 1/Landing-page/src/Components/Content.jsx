...
const Content = () => {
    return (
        <div className="container mt-5">
            <div className="row">
                <div className="col-12 col-lg-6 para mt-5">
                    <p>
                ...
                <div className="col-12 col-lg-6 img2 mt-5 mt-lg-0 d-flex justify-content-center">
                    <img src="https://i.etsystatic.com/18162651/r/il/360322/1569791658/il_570xN.1569791658_1o1y.jpg" alt="Arnold Schwarzenegger" className="img-fluid" />
                </div>
            </div>
        </div>
    );
